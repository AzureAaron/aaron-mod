...
public class Skyblock {
	public static final String[] MAX_LEVEL_SKYBLOCK_ENCHANTMENTS = {/* Armour */ "Aqua Affinity I", "Big Brain V", "Blast Protection VII", 
			...
			"Reflection V", "Rejuvenate V", "Respiration III", "Respite V", "Smarty Pants V", "Strong Mana X", "Sugar Rush III", "Thorns III", 
			...
			/* Equipment */ "Cayenne V", "Quantum V", /* Misc/Multipurpose */ "Experience V", "Rainbow I" };
