...
import net.azureaaron.mod.mixins.accessors.DirectStateAccessInvoker;
...
public class GlCommandEncoderMixin {
	...
	private static boolean aaronMod$replaceBufferData(DirectStateAccess manager, int buffer, long offset, ByteBuffer data, int usage, @Local(argsOnly = true) GpuBufferSlice gpuBufferSlice) {
