...
public abstract class AnvilScreenHandlerMixin extends ScreenHandler {
	...
	private void aaronMod$anvilColourCodeNaming() {
		if(Config.colourfulPartyFinderNotes && Functions.isOnHypixel() && MinecraftClient.getInstance().currentScreen.getTitle().getString().equals("Enter your note!")) this.newItemName = this.newItemName.replaceAll("&", "§");
	}
}
