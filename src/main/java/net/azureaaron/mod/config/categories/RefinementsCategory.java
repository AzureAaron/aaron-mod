	...
	public static ConfigCategory create(AaronModConfig defaults, AaronModConfig config) {
		return ConfigCategory.createBuilder()
				...
				.option(Option.<Boolean>createBuilder()
						...
						.description(OptionDescription.of(Text.literal("By default, Minecraft downloads skins over insecure HTTP; with this enabled skins are instead downloaded over HTTPS improving security and privacy.")))
				...
				.option(Option.<Boolean>createBuilder()
						...
						.description(OptionDescription.of(Text.literal("Silences some resource pack related errors that spam your log file.")))
				...
				.group(OptionGroup.createBuilder()
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("Allows you to copy a chat message by using middle or right click.")))
						...
						.option(Option.<RefinementsConfig.CopyChatMode>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("The mod offers two different modes when copying chat messages:")
						...
						.option(Option.<RefinementsConfig.MouseButton>createBuilder()
								.name(Text.literal("Copy Chat Mode"))
								.description(OptionDescription.of(Text.literal("Change the mouse button you use when copying chat. You can choose between middle click and right click.")))
						...
						.option(Option.<Integer>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("Change the maximum length of your chat history so that you don't miss any messages!")
				...
				.group(OptionGroup.createBuilder()
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("Prevents you for example from scrolling down to slot 9 from slot 1, and from scrolling up to slot 1 from slot 9 in the hotbar.\n\nThis also works with scrolling between items in bundles!")))
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("When enabled, the position of your cursor doesn't reset between chest GUIs.")))
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("Provides FN+F3+J as an alternate keybind for FN+F3+N.")))
				...
				.group(OptionGroup.createBuilder()
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("When enabled, item groups are appended to the lore of an item when you're outside of creative mode.")))
				...
				.group(OptionGroup.createBuilder()
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.literal("Prevents music from being abruptly stopped upon changing worlds or exiting to the title screen.")))
