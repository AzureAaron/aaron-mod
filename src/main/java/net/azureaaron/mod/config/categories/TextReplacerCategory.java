	...
	public static ConfigCategory create(AaronModConfig defaults, AaronModConfig config) {
		return ConfigCategory.createBuilder()
				...
				.option(Option.<Boolean>createBuilder()
						...
						.description(Text.literal("The text replacer allows you to visually replace almost any text on screen with whatever you want!")
				...
				.option(ButtonOption.createBuilder()
						...
						.prompt(Text.empty())
						.description(Text.literal("You can add text replacements with the command ")
				...
				.option(ButtonOption.createBuilder()
						...
						.description(Text.literal("Click to open a link to the website!"))
						.prompt(Text.literal("\u29C9"))
						.action(screen -> ConfirmLinkScreen.open(screen, "https://minecraft.tools/en/json_text.php"))
						.build())
