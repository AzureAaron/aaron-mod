...
public class OkLabColour {
	...
	/**
	 * Converts a colour in the OkLab colour space to linear SRGB.
	 */
	...
	public static int interpolate(int firstColour, int secondColour, float progress) {
		//Normalize colours to a range of [0, 1]
		float normalizedR1 = ((firstColour >> 16) & 0xFF) / 255f;
		float normalizedG1 = ((firstColour >> 8) & 0xFF) / 255f;
		float normalizedB1 = (firstColour & 0xFF) / 255f;

		float normalizedR2 = ((secondColour >> 16) & 0xFF) / 255f;
		float normalizedG2 = ((secondColour >> 8) & 0xFF) / 255f;
		float normalizedB2 = (secondColour & 0xFF) / 255f;
