...
import net.azureaaron.mod.Pair;
import net.azureaaron.mod.Processor;

public class ObjectProcessor {
	private static final String EQUALS = "Lnet/azureaaron/mod/annotations/GenEquals;";
	private static final String HASH_CODE = "Lnet/azureaaron/mod/annotations/GenHashCode;";
	private static final String TO_STRING = "Lnet/azureaaron/mod/annotations/GenToString;";
