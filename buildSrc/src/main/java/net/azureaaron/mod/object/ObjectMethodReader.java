...
import net.azureaaron.mod.utils.FieldReference;
import net.azureaaron.mod.utils.MethodReference;
import net.azureaaron.mod.utils.Pair;

public class ObjectMethodReader {
	private static final ClassDesc EQUALS_ANNOTATION_DESC = ClassDesc.of("net.azureaaron.mod.annotations.GenEquals");
	private static final ClassDesc HASH_CODE_ANNOTATION_DESC = ClassDesc.of("net.azureaaron.mod.annotations.GenHashCode");
	private static final ClassDesc TO_STRING_ANNOTATION_DESC = ClassDesc.of("net.azureaaron.mod.annotations.GenToString");
